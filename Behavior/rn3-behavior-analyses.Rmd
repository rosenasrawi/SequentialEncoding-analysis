...
ggplot(summary.err.load.moment.dial, 
  ...
  geom_errorbar(aes(ymin = difference-se, ymax = difference+se), width = 0.2, 
                position = position_dodge(1), size = 0.5, color = "black") +  
...
ggplot(rt.effects, aes(x = effectType, y = Effect, fill = effectType))+ 
  ...
  scale_fill_manual(values = c(color_3, color_1, color_0)) +
...
ggplot(rt.effects, aes(x = effectType, y = Effect, fill = effectType)) +
  ...
  geom_violin(alpha = 0.8, size = 1, width = 0.8, trim = FALSE) +
