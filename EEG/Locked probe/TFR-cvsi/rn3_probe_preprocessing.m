...
for this_subject = subjects
    ...
    cfg.trialdef.eventvalue = param.triggers_probe; % encoding
    cfg.trialdef.prestim    = param.T_probe_window(1); % from 1.5 sec before response onset
    cfg.trialdef.poststim   = param.T_probe_window(2); % til 1 sec after
...
%     pause()
    ...
    save([param.path, 'Processed/EEG/Locked probe/epoched probe/' 'epoched_probe_' param.subjectIDs{this_subject}], 'data'); % make sure to create the folder "saved_data" in the directory specified by your "path" above
