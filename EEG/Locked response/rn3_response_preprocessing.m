...
for this_subject = subjects
    ...
    cfg.trialdef.eventvalue = param.triggers_resp; % encoding
    cfg.trialdef.prestim    = param.T_resp_window(1); % from 1.5 sec before response onset
    cfg.trialdef.poststim   = param.T_resp_window(2); % til 1 sec after
    ...
    save([param.path, 'Processed/EEG/Locked response/epoched response/' 'epoched_response_' param.subjectIDs{this_subject}], 'data'); % make sure to create the folder "saved_data" in the directory specified by your "path" above
