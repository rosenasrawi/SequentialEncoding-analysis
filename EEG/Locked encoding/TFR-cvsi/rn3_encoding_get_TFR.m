...
%     trig_encoding_eeg = data.trialinfo;
%     trig_encoding_log = log.triggerEncoding1(this_sub_logindex);
%     trig_encoding_log = trig_encoding_log([1:384,405:end]);
%     
%     x = [trig_encoding_eeg, trig_encoding_log]
